...
/* 		Vector<Integer> rnd_5mi_hi = getRandomVector(5000000, HIGH_DIVERSITY);
		...
		Vector<Integer> rnd_20m_hi = getRandomVector(20000000, HIGH_DIVERSITY); */
		...
		ArrayList<TestableSort> testableSorts = new ArrayList();
...
/* 			tests.add(new SortTest(ts, "rnd 5mi high", rnd_5mi_hi));
			...
			tests.add(new SortTest(ts, "rnd 20m high", rnd_20m_hi)); */
	...
	private Vector<Integer> getSortedVector(int length, boolean ascending){
		Vector<Integer> res = new Vector(length);
